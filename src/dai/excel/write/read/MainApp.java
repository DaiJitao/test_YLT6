...
import dai.core.compute.ReadWriteExcelFile;
...
public class MainApp {
    ...
    public static void main1(String[] args) {
        ...
        for (int i = 0; i < 100; i++) {
            XSSFSheet sheet = readWriteExcelFile.getSheet("D:\\temp\\zeroDataAfter\\zero_xlsx\\2010_"+i+".xlsx");
            testWriteExcel.computeTop_00_index(sheet,i);
        }
...
//    }
    ...
    public void computeTop_00_index(XSSFSheet sheet, int i) {
        int rowIndex = 48;
        int cellIndex = 48;

//        String name11 = "WRA"; // 1，
//        WRA_createXLSX_And_saveData("D:\\temp\\index\\" + name11 + String.valueOf(i) + ".xlsx", name11, rowIndex, cellIndex, sheet);

//        String name7 = "AA"; // 1
//        AA_createXLSX_And_saveData("D:\\temp\\index_extra\\" + name7 + String.valueOf(i) +".xlsx", name7, rowIndex, cellIndex, sheet);//

//        String name10 = "WAA";
//        WAA_createXLSX_And_saveData("D:\\temp\\index\\" + String.valueOf(i) + name10 + ".xlsx", name10, rowIndex, cellIndex, sheet);//

//       String name8 = "RA";
//       RA_createXLSX_And_saveData("D:\\temp\\index\\" + name8 + String.valueOf(i) + ".xlsx", name8, rowIndex, cellIndex, sheet);//

//       String name9 = "WCN"; // 1，
//       WCN_createXLSX_And_saveData("D:\\temp\\index\\" + name9 + String.valueOf(i) + ".xlsx", name9, rowIndex, cellIndex, sheet);//

        String name12 = "rWCN";
        rWCN_createXLSX_And_saveData("D:\\temp\\index_extra\\rWCN\\" + name12 + String.valueOf(i) + ".xlsx", name12, rowIndex, cellIndex, sheet);//
        String name13 = "rWAA"; // 1，
        rWAA_createXLSX_And_saveData("D:\\temp\\index_extra\\rWAA\\" + name13 + String.valueOf(i) + ".xlsx", name13, rowIndex, cellIndex, sheet);//
        String name14 = "rWRA";
        rWRA_createXLSX_And_saveData("D:\\temp\\index_extra\\rWRA\\" + name14 + String.valueOf(i) + ".xlsx", name14, rowIndex, cellIndex, sheet);//

        String name4 = "CN"; // 1，
        //Salton_createXLSX_And_saveData("D:\\temp\\index\\" + name4 + ".xlsx", name4, rowIndex, cellIndex);//
        CN_createXLSX_And_saveData("D:\\temp\\index_extra\\CN\\" + name4 +  String.valueOf(i) + ".xlsx", name4, rowIndex, cellIndex, sheet);
...
//
    ...
    static void AA_createXLSX_And_saveData(String xlsxPath, String sheetName, int rowIndex, int cellIndex, XSSFSheet sheet) {
        XSSFWorkbook wb = new XSSFWorkbook();
        XSSFSheet sheet1 = wb.createSheet(sheetName);//在下标0处，创建一张表
        ...
        try {
            ...
            for (int i = 0; i < rowIndex; i++) {
                for (int j = i + 1; j < cellIndex; j++) {
                    ...
                    double temp = compute_index.AA_index(x, y, sheet);
                    //if (temp > 0.0) {
                        rowNums++;
                        XSSFRow row = sheet1.createRow(rowNums);
                        XSSFCell cell_0 = row.createCell(0);
...
//
    ...
    static void RA_createXLSX_And_saveData(String xlsxPath, String sheetName, int rowIndex, int cellIndex, XSSFSheet sheet) {
        XSSFWorkbook wb = new XSSFWorkbook();
        XSSFSheet sheet1 = wb.createSheet(sheetName);//在下标0处，创建一张表
        ...
        try {
            ...
            for (int i = 0; i < rowIndex; i++) {
                for (int j = i + 1; j < cellIndex; j++) {
                    ...
                    double temp = compute_index.RA_index(x, y, sheet);
                   // if (temp > 0.0) {
                        rowNums++;
                        XSSFRow row = sheet1.createRow(rowNums);
                        XSSFCell cell_0 = row.createCell(0);
...
//
    static void WCN_createXLSX_And_saveData(String xlsxPath, String sheetName, int rowIndex, int cellIndex, XSSFSheet sheet) {
        XSSFWorkbook wb = new XSSFWorkbook();
        XSSFSheet sheet1 = wb.createSheet(sheetName);//在下标0处，创建一张表
        ...
        try {
            ...
            for (int i = 0; i < rowIndex; i++) {
                for (int j = i + 1; j < cellIndex; j++) {
                    ...
                    double temp = compute_index.WCN_index(x, y, sheet);
                  //  if (temp > 0.0) {
                        rowNums++;
                        XSSFRow row = sheet1.createRow(rowNums);
                        XSSFCell cell_0 = row.createCell(0);
...
//
    ...
    static void WAA_createXLSX_And_saveData(String xlsxPath, String sheetName, int rowIndex, int cellIndex, XSSFSheet sheet) {
        XSSFWorkbook wb = new XSSFWorkbook();
        XSSFSheet sheet1 = wb.createSheet(sheetName);//在下标0处，创建一张表
        ...
        try {
            ...
            for (int i = 0; i < rowIndex; i++) {
                for (int j = i + 1; j < cellIndex; j++) {
                    ...
                    double temp = compute_index.WAA_index(x, y, sheet);
                   // if (temp > 0.0) {
                        rowNums++;
                        XSSFRow row = sheet1.createRow(rowNums);
                        XSSFCell cell_0 = row.createCell(0);
...
//
    ...
    static void WRA_createXLSX_And_saveData(String xlsxPath, String sheetName, int rowIndex, int cellIndex, XSSFSheet sheet) {
        XSSFWorkbook wb = new XSSFWorkbook();
        XSSFSheet sheet1 = wb.createSheet(sheetName);//在下标0处，创建一张表
        ...
        try {
            ...
            for (int i = 0; i < rowIndex; i++) {
                for (int j = i + 1; j < cellIndex; j++) {
                    ...
                    double temp = compute_index.WRA_index(x, y, sheet);
                    //if (temp > 0.0) {
                        rowNums++;
                        XSSFRow row = sheet1.createRow(rowNums);
                        XSSFCell cell_0 = row.createCell(0);
    ...
    static void rWCN_createXLSX_And_saveData(String xlsxPath, String sheetName, int rowIndex, int cellIndex, XSSFSheet sheet) {
        XSSFWorkbook wb = new XSSFWorkbook();
        XSSFSheet sheet1 = wb.createSheet(sheetName);//在下标0处，创建一张表
        ...
        try {
            ...
            for (int i = 0; i < rowIndex; i++) {
                for (int j = i + 1; j < cellIndex; j++) {
                    ...
                    double temp = compute_index.rWCN_index(x, y, sheet);
                    //if (temp > 0.0) {
                        rowNums++;
                        XSSFRow row = sheet1.createRow(rowNums);
                        XSSFCell cell_0 = row.createCell(0);
...
//
    ...
    static void rWAA_createXLSX_And_saveData(String xlsxPath, String sheetName, int rowIndex, int cellIndex, XSSFSheet sheet) {
        XSSFWorkbook wb = new XSSFWorkbook();
        XSSFSheet sheet1 = wb.createSheet(sheetName);//在下标0处，创建一张表
        ...
        try {
            ...
            for (int i = 0; i < rowIndex; i++) {
                for (int j = i + 1; j < cellIndex; j++) {
                    ...
                    double temp = compute_index.rWAA_index(x, y, sheet);
               //     if (temp > 0.0) {
                        rowNums++;
                        XSSFRow row = sheet1.createRow(rowNums);
                        XSSFCell cell_0 = row.createCell(0);
...
//
    ...
    static void rWRA_createXLSX_And_saveData(String xlsxPath, String sheetName, int rowIndex, int cellIndex, XSSFSheet sheet) {
        XSSFWorkbook wb = new XSSFWorkbook();
        XSSFSheet sheet1 = wb.createSheet(sheetName);//在下标0处，创建一张表
        ...
        try {
            ...
            for (int i = 0; i < rowIndex; i++) {
                for (int j = i + 1; j < cellIndex; j++) {
                    ...
                    double temp = compute_index.rWRA_index(x, y, sheet);
                   // if (temp > 0.0) {
                        rowNums++;
                        XSSFRow row = sheet1.createRow(rowNums);
                        XSSFCell cell_0 = row.createCell(0);
...
//
    ...
    static void CN_createXLSX_And_saveData(String xlsxPath, String sheetName, int rowIndex, int cellIndex, XSSFSheet sheet) {
        XSSFWorkbook wb = new XSSFWorkbook();
        XSSFSheet sheet1 = wb.createSheet(sheetName);//在下标0处，创建一张表
        ...
        try {
            ...
            for (int i = 0; i < rowIndex; i++) {
                for (int j = i + 1; j < cellIndex; j++) {
                    ...
                    double temp = compute_index.CN_index(x, y, sheet);
                   // if (temp > 0.0) {
                        rowNums++;
                        XSSFRow row = sheet1.createRow(rowNums);
                        XSSFCell cell_0 = row.createCell(0);

...
public class ReadExcelTwoPL {
	public static void main(String[] args) throws Exception{
		String path = "D:\\temp\\feng2.0\\2013spa_rawdata.xlsx";
		String pathComAPL = "D:\\temp\\feng2.0\\comA.txt";
